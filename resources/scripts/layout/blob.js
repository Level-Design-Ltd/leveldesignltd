...
class Blob {
    ...
    render() {
        ...
        for (let i = 1; i < points; i++) {
            ...
            if (
                i === Math.floor(points / 4) ||
                i === Math.floor((points * 3) / 4)
            ) {
...
class Point {
    ...
    get position() {
        ...
        let distortion =
            1 + distortionFactor * Math.sin(this.azimuth + azimuthOffset);

        let position = {
            x:
                this.parent.center.x +
                distortion * (undistorted.x - this.parent.center.x),
            y:
                this.parent.center.y +
                distortion * (undistorted.y - this.parent.center.y),
        };
