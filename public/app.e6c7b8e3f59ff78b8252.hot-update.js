...
window.onload = () => {
  ...
  var posX = style.getPropertyValue("--blob-position-x");
  var posY = style.getPropertyValue("--blob-position-y");
};
blob.position = {
  x: parseFloat(posX),
  y: parseFloat(posY)
...
//# sourceMappingURL=app.e6c7b8e3f59ff78b8252.hot-update.js.map