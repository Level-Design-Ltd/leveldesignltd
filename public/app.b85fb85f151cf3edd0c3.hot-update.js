...
window.onload = function () {
  ...
  console.log(style.getPropertyValue("--blob-position-x"));
  console.log(style.getPropertyValue("--blob-position-y"));
};
blob.position = {
...
//# sourceMappingURL=app.b85fb85f151cf3edd0c3.hot-update.js.map