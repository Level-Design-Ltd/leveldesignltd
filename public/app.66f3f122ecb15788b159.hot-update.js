...
init = function () {
  ...
  let mouseMove = function (e) {
    ...
    let angle = null;
    let hoverRadius = blob.radius * 1.5; // increase this factor to increase the hover effect area

    blob.mousePos = {
      x: pos.x - e.clientX,
      y: pos.y - e.clientY
    };
    if (dist < hoverRadius && hover === false) {
      let vector = {
        x: e.clientX - pos.x,
        y: e.clientY - pos.y
      };
      ...
      hover = true;
    } else if (dist > hoverRadius && hover === true) {
      let vector = {
        x: e.clientX - pos.x,
        y: e.clientY - pos.y
      };
...
//# sourceMappingURL=app.66f3f122ecb15788b159.hot-update.js.map